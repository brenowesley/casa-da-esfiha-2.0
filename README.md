...
🛒 Carrinho Inteligente: Gerenciamento de pedidos com persistência local.
🔐 Painel do Gerente: Área restrita para cadastro de produtos, controle de estoque (No Ar / Pausado) e alteração de preços.
🎨 UI Premium: Animações fluidas com Framer Motion e estilização moderna com Tailwind CSS.
