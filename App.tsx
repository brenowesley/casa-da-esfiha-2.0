...
import { ShoppingBasket, Instagram, Lock, Settings } from 'lucide-react';
  ...
  const handleToggleAvailability = (id: string) => {
    ...
    setCart(prev => prev.filter(item => {
      if (item.id === id) {
        ...
        // Note: we are looking at the *previous* state in products, but we know we are toggling it.
        // Actually, safer to filter after update, but for simplicity:
        return true; 
      }
      return true;
    }));
